            ...
            children: [
              {
                ...
                route: '/forms/apps/help-center/getting-started'
              },
              {
                type: 'link',
                label: 'Pricing & Plans',
                route: '/forms/apps/help-center/pricing'
              },
              {
                type: 'link',
                label: 'FAQ',
                route: '/forms/apps/help-center/faq'
              },
              {
                type: 'link',
                label: 'Guides',
                route: '/forms/apps/help-center/guides'
              }
            ]
          },
          {
            ...
            children: [
              {
                type: 'link',
                label: 'Profile',
                route: '/forms/apps/social',
                routerLinkActiveOptions: { exact: true }
              },
              {
                type: 'link',
                label: 'Timeline',
                route: '/forms/apps/social/timeline'
              },
            ]
          },
          {
            ...
            children: [
              {
                type: 'link',
                label: 'List - Grid',
                route: '/forms/apps/contacts/grid',
              },
              {
                type: 'link',
                label: 'List - Table',
                route: '/forms/apps/contacts/table',
              }
            ]
          },
          {
